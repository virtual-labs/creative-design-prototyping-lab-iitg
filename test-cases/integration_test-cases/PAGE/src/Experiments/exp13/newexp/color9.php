<?php
	if(isset($_POST['time'])){
		...
		if($time=="")
		{
			...
			$_SESSION['timec9']=$time-1;
		
			header("Location:color10.php");
		}
	}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload = "StartTimer()">
        <form name="slide" action="color9.php" method="POST">
            <div class="slide">
		<p style="width: auto;
			  height: auto;
			  font-size: 20px;
			...
			9/12
                ...
                <div class="letter">
                    <div class="color" style=" margin-right: 48px;">
                        <div class="col1" style="background-color: green; margin: 10px; width: 180px; height: 230px;">
			</div>
                    </div>
