...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload = "StartTimer()">
        <form name="slide" action="image4.php" method="POST">
            <div class="slide">
		<p style="width: auto;
			  height: auto;
			  font-size: 20px;
			...
			4/12
                ...
                <div class="letter">
                    <div class="color1" style=" margin-right: 48px;">
                        <img alt="image" src="images/logo/img4.png" width="200px" height="200px" />
                    </div>
                    
                    <div class="color1">
                        <img alt="image" src="images/logo/img44.png" width="200px" height="200px" />
                    </div>
                </div>
