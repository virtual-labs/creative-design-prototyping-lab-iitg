<?php
	if(isset($_POST['time'])){
		...
		if($time=="")
		{
			...
			$_SESSION['timec12']=$time-1;
		
			header("Location:finishcolor.php");
		}
	}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload = "StartTimer()">
        <form name="slide" action="color12.php" method="POST">
            <div class="slide">
		<p style="width: auto;
			  height: auto;
			  font-size: 20px;
			...
			12/12
                ...
                <div class="letter">
                    <div class="color" style=" margin-right: 48px;">
                        <div class="col1" style="background-color: blue; margin: 10px; width: 180px; height: 230px;">
			</div>
                    </div>
                    
                    <div class="color" id="hid" style="visibility: hidden">
                        <div class="col2" style="background-color: pink; margin: 10px; width: 180px; height: 230px;">
			</div>
                    </div>
