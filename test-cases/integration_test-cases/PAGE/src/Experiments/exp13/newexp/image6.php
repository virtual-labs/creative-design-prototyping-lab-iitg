<?php
	if(isset($_POST['time'])){
		...
		if($time=="")
		{
			...
			$_SESSION['timei6']=$time-1;
		
			header("Location:image7.php");
		}
	}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload = "StartTimer()">
        <form name="slide" action="image6.php" method="POST">
            <div class="slide">
		<p style="width: auto;
			  height: auto;
			  font-size: 20px;
			...
			6/12
                ...
                <div class="letter">
                    <div class="color1" style=" margin-right: 48px;">
                        <img alt="img1" src="images/logo/img2.png" width="200px" height="200px" />
                    </div>
		...
		<div id="myDiv" class="myDiv" style="text-align: center; margin: 20px; color: red">
		</div>
