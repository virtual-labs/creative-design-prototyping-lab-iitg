<?php
    ...
    imageline ($im,80,$c5,180,$c6,$green);
    imageline ($im,180,$c6,280,$c7,$green);
    imageline ($im,280,$c7,380,$c8,$green);
    
    
    
    //circles to indicate the points on the graphs
    imageellipse ($im, 80, $c5, 10, 10, $blue);
    imageellipse ($im, 180, $c6, 10, 10, $blue);
    imageellipse ($im, 280, $c7, 10, 10, $blue);
    imageellipse ($im, 380, $c8, 10, 10, $blue);
