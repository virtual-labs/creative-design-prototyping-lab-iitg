<?php
	if(isset($_POST['time'])){
		...
		if($time=="")
		{
			...
			$_SESSION['timei11']=$time-1;
		
			header("Location:image12.php");
		}
	}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload = "StartTimer()">
        <form name="slide" action="image11.php" method="POST">
            <div class="slide">
		<p style="width: auto;
			  height: auto;
			  font-size: 20px;
			...
			11/12
                ...
                <div class="letter">
                    <div class="color1" style=" margin-right: 48px;">
                        <img alt="img1" src="images/logo/img3.png" width="200px" height="200px" />
                    </div>
                    
                    <div class="color1" id="hid" style="visibility: hidden">
                        <img alt="img1" src="images/logo/img33.png" width="200px" height="200px" />
                    </div>
