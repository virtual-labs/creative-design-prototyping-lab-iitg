<?php
	if(isset($_POST['time'])){
		...
		if($time=="")
		{
			...
			$_SESSION['timei9']=$time-1;
		
			header("Location:image10.php");
		}
	}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload = "StartTimer()">
        <form name="slide" action="image9.php" method="POST">
            <div class="slide">
		<p style="width: auto;
			  height: auto;
			  font-size: 20px;
			...
			9/12
                ...
                <div class="letter">
                    <div class="color1" style=" margin-right: 48px;">
                        <img alt="img1" src="images/logo/img1.png" width="200px" height="200px" />
                    </div>
                    
                    <div class="color1" id="hid" style="visibility: hidden">
                        <img alt="img1" src="images/logo/img11.png" width="200px" height="200px" />
                    </div>
