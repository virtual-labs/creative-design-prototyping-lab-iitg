<?php
    ...
    imageline ($im,100,$c2,200,$c5,$yellow);
    imageline ($im,200,$c5,300,$c9,$yellow);
    
    imageline ($im,100,$c4,200,$c8,$green);
    imageline ($im,200,$c8,300,$c12,$green);
    ...
    */
    ...
    imageellipse ($im, 200, $c5, 10, 10, $yellow);
    imageellipse ($im, 300, $c9, 10, 10, $yellow);
    
    imageellipse ($im, 100, $c4, 10, 10, $red);
    imageellipse ($im, 200, $c8, 10, 10, $red);
    imageellipse ($im, 300, $c12, 10, 10, $red);
    ...
    imagestring($im, 5, 100, $c4-20, '(A, b)', $text_color);
    imagestring($im, 5, 200, $c8-20, '(F, g)', $text_color);
    imagestring($im, 5, 300, $c12-20, '(K, l)', $text_color);
